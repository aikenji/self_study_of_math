...
By the \Cref{lem:class to be set}, Some sets operations below are well defined and can be used to create new sets.

\begin{corollary}{}{}
    Intersection and Difference of sets can be defined by \Cref{lem:class to be set}.
    \begin{enumerate}
